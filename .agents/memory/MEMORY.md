...
- [Automatic debt import](debt-import-feature.md) — Plaid prod APPROVED 2026-07-17; promotion config-only + founder-run (prod secret, PLAID_ENV, redirect URI fix); gaps listed inside.
