...
- Stripe Financial Connections registration **APPROVED — live-verified 2026-07-24**: founder's iPhone test created a live FC session and the full bank-picker rendered in-app. First live exchange attempt (2026-07-25) hit the duplicate re-link 502 (Stage 4 in agent memory) — idempotent re-link fix is in the workspace, **PENDING REPUBLISH**. Final proof: one completed link. Plaid in-app OAuth resume (Chase): web telemetry live since the 2026-07-25 republish; native needs build ≥210.
